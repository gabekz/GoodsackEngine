...
static VkFormat _FindSupportedFormat(VkPhysicalDevice physicalDevice,
        VkFormat *candidates, int candidateCount,
        VkImageTiling tiling, VkFormatFeatureFlags features)
{
    ...
    // TODO: Fix. I was in a rush.
    VkFormat failed;
    return failed;
}

static ui32 _HasStencilComponent(VkFormat format)
{
        ...
        VkDevice device, VkExtent2D swapChainExtent)
{
    ...
    vulkan_image_create(physicalDevice, device,
            &ret->depthImage, &ret->depthImageMemory,
    ...
    ret->depthImageView =
            vulkan_image_view_create(device, ret->depthImage, depthFormat,
